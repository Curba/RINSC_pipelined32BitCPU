...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->chgCData(oldp+420,(vlSelf->Op),8);
    tracep->chgBit(oldp+421,(vlSelf->top__DOT__transfer_in_progress));
    tracep->chgBit(oldp+422,((1U & (((((0U != (0xfU 
                                               & (vlSelf->top__DOT__datapath__DOT__IdEx[5U] 
                                                  >> 0xdU))) 
                                       & (((0x1fU & 
                                            (vlSelf->top__DOT__datapath__DOT__IdEx[0U] 
    ...
    tracep->chgBit(oldp+423,(vlSelf->top__DOT__datapath__DOT__PCenable));
