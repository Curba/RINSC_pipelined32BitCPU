...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBit(c+416,"clock", false,-1);
    tracep->declBit(c+417,"reset", false,-1);
    tracep->declBus(c+418,"Op", false,-1, 7,0);
    ...
    tracep->declBit(c+432,"icache_instrRequest", false,-1);
    ...
    tracep->declBus(c+35,"datamem_write_data", false,-1, 31,0);
    tracep->declBus(c+36,"ForwardingA", false,-1, 1,0);
    tracep->declBus(c+37,"ForwardingB", false,-1, 1,0);
    tracep->declBit(c+38,"ForwardingC", false,-1);
    tracep->declBit(c+39,"ForwardingD", false,-1);
    tracep->declBit(c+420,"stall_flag", false,-1);
    tracep->declBit(c+421,"PCenable", false,-1);
    tracep->declBit(c+422,"IfIdEN", false,-1);
    tracep->declBit(c+40,"flush", false,-1);
    ...
    tracep->declBus(c+423,"da", false,-1, 31,0);
    tracep->declBus(c+424,"db", false,-1, 31,0);
    tracep->declBus(c+425,"dc", false,-1, 31,0);
    ...
    tracep->declBit(c+407,"icache_blockRequest", false,-1);
    tracep->declBit(c+408,"icache_blockReady", false,-1);
    tracep->declBus(c+24,"icache_blockAddress", false,-1, 11,0);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+78+i*1,"icache_instructionBlock", true,(i+0), 31,0);
    }
    tracep->declBit(c+367,"dcache_blockRequest", false,-1);
    tracep->declBit(c+409,"dcache_blockReady", false,-1);
    tracep->declBit(c+368,"dcache_mem_rw", false,-1);
    tracep->declBus(c+86,"dcache_blockAddress", false,-1, 11,0);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+87+i*1,"dcache_readBlock", true,(i+0), 31,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+95+i*1,"dcache_wbBlock", true,(i+0), 31,0);
    }
    ...
    tracep->declBit(c+33,"dcache_data_ready", false,-1);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+103+i*1,"mem_data_in", true,(i+0), 31,0);
    }
    tracep->declBit(c+409,"mem_ready", false,-1);
    tracep->declBus(c+86,"mem_address", false,-1, 11,0);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+111+i*1,"mem_data_out", true,(i+0), 31,0);
    }
    tracep->declBit(c+368,"mem_rw", false,-1);
    tracep->declBit(c+367,"mem_valid", false,-1);
    tracep->declBus(c+369,"nstate", false,-1, 2,0);
    tracep->declBus(c+119,"cstate", false,-1, 2,0);
    tracep->declBit(c+120,"dcache_valid_read", false,-1);
    tracep->declBit(c+121,"dcache_dirty_read", false,-1);
    tracep->declBus(c+122,"dcache_tag_read", false,-1, 11,9);
    tracep->declBit(c+123,"dcache_valid_write", false,-1);
    tracep->declBit(c+124,"dcache_dirty_write", false,-1);
    tracep->declBus(c+125,"dcache_tag_write", false,-1, 11,9);
    tracep->declBus(c+126,"dcache_tag_index", false,-1, 3,0);
    ...
    tracep->declBus(c+126,"dcache_sram_index", false,-1, 3,0);
    ...
    tracep->declBus(c+86,"mem_request_address", false,-1, 11,0);
    for (int i = 0; i < 8; ++i) {
    ...
    tracep->declBus(c+126,"index", false,-1, 3,0);
    for (int i = 0; i < 8; ++i) {
    ...
    tracep->declBus(c+126,"index", false,-1, 3,0);
    tracep->declBit(c+123,"valid_in", false,-1);
    tracep->declBit(c+124,"dirty_in", false,-1);
    tracep->declBus(c+125,"tag_in", false,-1, 11,9);
    tracep->declBit(c+120,"valid_out", false,-1);
    tracep->declBit(c+121,"dirty_out", false,-1);
    tracep->declBus(c+122,"tag_out", false,-1, 11,9);
    for (int i = 0; i < 16; ++i) {
    ...
    tracep->declBit(c+416,"clock", false,-1);
    tracep->declBit(c+417,"reset", false,-1);
    tracep->declBit(c+407,"dram_port1_request", false,-1);
    ...
    tracep->declBit(c+408,"dram_port1_acknowledge", false,-1);
    tracep->declBit(c+367,"dram_port2_request", false,-1);
    tracep->declBus(c+86,"dram_port2_address", false,-1, 11,0);
    ...
    tracep->declBit(c+409,"dram_port2_acknowledge", false,-1);
    tracep->declBit(c+419,"dram_busy", false,-1);
    tracep->declBit(c+426,"dram_port1_busy", false,-1);
    tracep->declBit(c+427,"dram_port2_busy", false,-1);
    tracep->pushNamePrefix("dram_interface_dcache ");
    tracep->declBit(c+416,"clock", false,-1);
    tracep->declBit(c+417,"reset", false,-1);
    tracep->declBus(c+86,"bus_address_to_mem", false,-1, 11,0);
    for (int i = 0; i < 8; ++i) {
    ...
    tracep->declBit(c+409,"acknowledge_from_mem", false,-1);
    tracep->declBus(c+410,"data_pin", false,-1, 31,0);
    for (int i = 0; i < 8; ++i) {
    ...
    tracep->declBus(c+411,"address_to_mem_with_word_offset", false,-1, 11,0);
    ...
    tracep->declBit(c+409,"acknowledge", false,-1);
    tracep->declBus(c+412,"word_count", false,-1, 2,0);
    tracep->declBus(c+253,"cycle_count", false,-1, 1,0);
    tracep->pushNamePrefix("dram ");
    tracep->declBit(c+416,"clock", false,-1);
    tracep->declBit(c+417,"reset", false,-1);
    tracep->declBus(c+411,"address", false,-1, 11,0);
    tracep->declBus(c+410,"data", false,-1, 31,0);
    ...
    tracep->declBit(c+426,"bus_read_enable", false,-1);
    ...
    tracep->declBit(c+432,"icache_valid", false,-1);
    for (int i = 0; i < 8; ++i) {
    ...
    tracep->declBit(c+407,"mem_valid", false,-1);
    ...
    tracep->declBit(c+407,"mem_request_valid", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+31,((0xfU & (vlSelf->top__DOT__datapath__DOT__ExMem[4U] 
                                        >> 1U))),4);
    tracep->fullIData(oldp+32,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__dcache_data_to_cpu),32);
    ...
    tracep->fullIData(oldp+35,((((0U != (0x1fU & vlSelf->top__DOT__datapath__DOT__MemWb[0U])) 
                                 ...
                                 : ((vlSelf->top__DOT__datapath__DOT__ExMem[2U] 
                                     << 4U) | (vlSelf->top__DOT__datapath__DOT__ExMem[1U] 
                                               >> 0x1cU)))),32);
    tracep->fullCData(oldp+36,(vlSelf->top__DOT__datapath__DOT__ForwardingA),2);
    tracep->fullCData(oldp+37,(vlSelf->top__DOT__datapath__DOT__ForwardingB),2);
    tracep->fullBit(oldp+38,(((((vlSelf->top__DOT__datapath__DOT__MemWb[2U] 
                                 >> 7U) & (0U != (0x1fU 
                              ...
                              ((0x1fU & vlSelf->top__DOT__datapath__DOT__MemWb[0U]) 
                               == (0x1fU & (vlSelf->top__DOT__datapath__DOT__ExMem[0U] 
                                            >> 0x12U))))));
    tracep->fullBit(oldp+39,(((0U != (0x1fU & vlSelf->top__DOT__datapath__DOT__MemWb[0U])) 
                              & ((0x1fU & vlSelf->top__DOT__datapath__DOT__MemWb[0U]) 
                                 == (0x1fU & (vlSelf->top__DOT__datapath__DOT__ExMem[0U] 
                                              >> 0x17U))))));
    tracep->fullBit(oldp+40,(vlSelf->top__DOT__datapath__DOT__flush));
    ...
    tracep->fullBit(oldp+72,(vlSelf->top__DOT__datapath__DOT__branch_src));
    ...
    tracep->fullIData(oldp+78,(vlSelf->top__DOT__memory__DOT__icache_instructionBlock[0]),32);
    tracep->fullIData(oldp+79,(vlSelf->top__DOT__memory__DOT__icache_instructionBlock[1]),32);
    tracep->fullIData(oldp+80,(vlSelf->top__DOT__memory__DOT__icache_instructionBlock[2]),32);
    tracep->fullIData(oldp+81,(vlSelf->top__DOT__memory__DOT__icache_instructionBlock[3]),32);
    tracep->fullIData(oldp+82,(vlSelf->top__DOT__memory__DOT__icache_instructionBlock[4]),32);
    tracep->fullIData(oldp+83,(vlSelf->top__DOT__memory__DOT__icache_instructionBlock[5]),32);
    tracep->fullIData(oldp+84,(vlSelf->top__DOT__memory__DOT__icache_instructionBlock[6]),32);
    tracep->fullIData(oldp+85,(vlSelf->top__DOT__memory__DOT__icache_instructionBlock[7]),32);
    tracep->fullSData(oldp+86,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__mem_request_address),12);
    tracep->fullIData(oldp+87,(vlSelf->top__DOT__memory__DOT__dcache_readBlock[0]),32);
    tracep->fullIData(oldp+88,(vlSelf->top__DOT__memory__DOT__dcache_readBlock[1]),32);
    tracep->fullIData(oldp+89,(vlSelf->top__DOT__memory__DOT__dcache_readBlock[2]),32);
    tracep->fullIData(oldp+90,(vlSelf->top__DOT__memory__DOT__dcache_readBlock[3]),32);
    tracep->fullIData(oldp+91,(vlSelf->top__DOT__memory__DOT__dcache_readBlock[4]),32);
    tracep->fullIData(oldp+92,(vlSelf->top__DOT__memory__DOT__dcache_readBlock[5]),32);
    tracep->fullIData(oldp+93,(vlSelf->top__DOT__memory__DOT__dcache_readBlock[6]),32);
    tracep->fullIData(oldp+94,(vlSelf->top__DOT__memory__DOT__dcache_readBlock[7]),32);
    tracep->fullIData(oldp+95,(vlSelf->top__DOT__memory__DOT__dcache_wbBlock[0]),32);
    tracep->fullIData(oldp+96,(vlSelf->top__DOT__memory__DOT__dcache_wbBlock[1]),32);
    tracep->fullIData(oldp+97,(vlSelf->top__DOT__memory__DOT__dcache_wbBlock[2]),32);
    tracep->fullIData(oldp+98,(vlSelf->top__DOT__memory__DOT__dcache_wbBlock[3]),32);
    tracep->fullIData(oldp+99,(vlSelf->top__DOT__memory__DOT__dcache_wbBlock[4]),32);
    tracep->fullIData(oldp+100,(vlSelf->top__DOT__memory__DOT__dcache_wbBlock[5]),32);
    tracep->fullIData(oldp+101,(vlSelf->top__DOT__memory__DOT__dcache_wbBlock[6]),32);
    tracep->fullIData(oldp+102,(vlSelf->top__DOT__memory__DOT__dcache_wbBlock[7]),32);
    tracep->fullIData(oldp+103,(vlSelf->top__DOT__memory__DOT____Vcellinp__dcache_controller__mem_data_in[0]),32);
    tracep->fullIData(oldp+104,(vlSelf->top__DOT__memory__DOT____Vcellinp__dcache_controller__mem_data_in[1]),32);
    tracep->fullIData(oldp+105,(vlSelf->top__DOT__memory__DOT____Vcellinp__dcache_controller__mem_data_in[2]),32);
    tracep->fullIData(oldp+106,(vlSelf->top__DOT__memory__DOT____Vcellinp__dcache_controller__mem_data_in[3]),32);
    tracep->fullIData(oldp+107,(vlSelf->top__DOT__memory__DOT____Vcellinp__dcache_controller__mem_data_in[4]),32);
    tracep->fullIData(oldp+108,(vlSelf->top__DOT__memory__DOT____Vcellinp__dcache_controller__mem_data_in[5]),32);
    tracep->fullIData(oldp+109,(vlSelf->top__DOT__memory__DOT____Vcellinp__dcache_controller__mem_data_in[6]),32);
    tracep->fullIData(oldp+110,(vlSelf->top__DOT__memory__DOT____Vcellinp__dcache_controller__mem_data_in[7]),32);
    tracep->fullIData(oldp+111,(vlSelf->top__DOT__memory__DOT____Vcellout__dcache_controller__mem_data_out[0]),32);
    tracep->fullIData(oldp+112,(vlSelf->top__DOT__memory__DOT____Vcellout__dcache_controller__mem_data_out[1]),32);
    tracep->fullIData(oldp+113,(vlSelf->top__DOT__memory__DOT____Vcellout__dcache_controller__mem_data_out[2]),32);
    tracep->fullIData(oldp+114,(vlSelf->top__DOT__memory__DOT____Vcellout__dcache_controller__mem_data_out[3]),32);
    tracep->fullIData(oldp+115,(vlSelf->top__DOT__memory__DOT____Vcellout__dcache_controller__mem_data_out[4]),32);
    tracep->fullIData(oldp+116,(vlSelf->top__DOT__memory__DOT____Vcellout__dcache_controller__mem_data_out[5]),32);
    tracep->fullIData(oldp+117,(vlSelf->top__DOT__memory__DOT____Vcellout__dcache_controller__mem_data_out[6]),32);
    tracep->fullIData(oldp+118,(vlSelf->top__DOT__memory__DOT____Vcellout__dcache_controller__mem_data_out[7]),32);
    tracep->fullCData(oldp+119,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__cstate),3);
    tracep->fullBit(oldp+120,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__dcache_valid_read));
    tracep->fullBit(oldp+121,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__dcache_dirty_read));
    tracep->fullCData(oldp+122,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__dcache_tag_read),3);
    tracep->fullBit(oldp+123,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__dcache_valid_write));
    tracep->fullBit(oldp+124,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__dcache_dirty_write));
    tracep->fullCData(oldp+125,(vlSelf->top__DOT__memory__DOT__dcache_controller__DOT__dcache_tag_write),3);
    tracep->fullCData(oldp+126,((0xfU & (vlSelf->top__DOT__datapath__DOT__ExMem[3U] 
                                         >> 1U))),4);
    ...
    tracep->fullBit(oldp+407,(vlSelf->top__DOT__memory__DOT__icache_controller__DOT__mem_request_valid));
    tracep->fullBit(oldp+408,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_icache__DOT__acknowledge));
    tracep->fullBit(oldp+409,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_dcache__DOT__acknowledge));
    tracep->fullIData(oldp+410,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_dcache__DOT__data_pin),32);
    tracep->fullSData(oldp+411,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_dcache__DOT__address_to_mem_with_word_offset),12);
    tracep->fullCData(oldp+412,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_dcache__DOT__word_count),3);
    tracep->fullIData(oldp+413,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_icache__DOT__data_pin),32);
    tracep->fullSData(oldp+414,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_icache__DOT__address_to_mem_with_word_offset),12);
    tracep->fullCData(oldp+415,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_icache__DOT__word_count),3);
    tracep->fullBit(oldp+416,(vlSelf->clock));
    tracep->fullBit(oldp+417,(vlSelf->reset));
    tracep->fullCData(oldp+418,(vlSelf->Op),8);
    ...
    tracep->fullBit(oldp+421,(vlSelf->top__DOT__datapath__DOT__PCenable));
    tracep->fullBit(oldp+422,((1U & (~ (((((0U != (0xfU 
                                                   & (vlSelf->top__DOT__datapath__DOT__IdEx[5U] 
                                                      >> 0xdU))) 
                                           & (((0x1fU 
                                                & (vlSelf->top__DOT__datapath__DOT__IdEx[0U] 
    ...
    tracep->fullIData(oldp+423,(vlSelf->top__DOT__datapath__DOT__RF
                                [(0x1fU & (IData)((vlSelf->top__DOT__datapath__DOT__IfId 
                                                   >> 0x22U)))]),32);
    tracep->fullIData(oldp+424,(((IData)(vlSelf->top__DOT__RbSelect)
    ...
    tracep->fullIData(oldp+425,(vlSelf->top__DOT__datapath__DOT__RF
                                [(0x1fU & (IData)((vlSelf->top__DOT__datapath__DOT__IfId 
                                                   >> 0x18U)))]),32);
    tracep->fullBit(oldp+426,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_port1_busy));
    tracep->fullBit(oldp+427,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_port2_busy));
    tracep->fullBit(oldp+428,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_dcache__DOT__we));
    tracep->fullBit(oldp+429,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_dcache__DOT__re));
    tracep->fullBit(oldp+430,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_icache__DOT__we));
    tracep->fullBit(oldp+431,(vlSelf->top__DOT__memory__DOT__dram_controller__DOT__dram_interface_icache__DOT__re));
